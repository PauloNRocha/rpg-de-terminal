...
def jogador_base() -> Personagem:
    """Cria um dicionário de jogador base para ser usado nos testes."""
    return {
        "nome": "Teste",
        "classe": "Guerreiro",
        "hp": 25,
...
def test_aplicar_bonus_arma(jogador_base: Personagem) -> None:
...
def test_aplicar_bonus_escudo(jogador_base: Personagem) -> None:
...
def test_aplicar_bonus_arma_e_escudo(jogador_base: Personagem) -> None:
...
def test_remover_equipamento(jogador_base: Personagem) -> None:
