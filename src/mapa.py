...
INIMIGOS = {
    "goblin": {"nome": "Goblin", "hp": 10, "ataque": 4, "defesa": 1, "drop_raridade": "comum"},
    "orc": {"nome": "Orc", "hp": 20, "ataque": 6, "defesa": 3, "drop_raridade": "incomum"},
    "chefe": {"nome": "O Terrível Orc Chefe", "hp": 40, "ataque": 8, "defesa": 4, "drop_raridade": "raro"}
}

# Define o mapa do jogo, agora sem itens estáticos
MAPA = [
    [
        ...
        {"nome": "Câmara com Ossos", "descricao": "Uma pequena câmara com uma pilha de ossos roídos em um canto. Algo esteve aqui.", "inimigo": None, "item": None}
    ],
    [
        ...
        {"nome": "Fonte Misteriosa", "descricao": "Uma pequena fonte de água cristalina brota do chão. A água parece brilhar.", "inimigo": None, "item": None}
    ],
    [
